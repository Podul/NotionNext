...
export default function NavBar(props) {
  ...
  return (
    <nav className='w-full bg-white md:pt-0  z-20 shadow border-t border-gray-100 dark:border-hexo-black-gray dark:bg-black sticky top-0'>
      <div
        id='nav-bar-inner'
        ...
        <div className='absolute right-12 h-full text-center px-2 flex items-center text-gray-700 dark:text-gray-200 cursor-pointer'>
          {/* <!-- extra links --> */}
          <i
            className={
              showSearchInput
